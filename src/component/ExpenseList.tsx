...
const ExpenseContainer = styled.div`
  ...
  margin: 20px;
`;
const ExpenseBox = styled.div<{ isIncome?: boolean }>`
  border-radius: 4px;
...
const AddTransaction = styled.div`
  ...
  font-weight: bold;
`;
const AddTransactionContainer = styled.div<{ isAddTxnVisible: boolean }>`
  font-size: 15px;
...
`;
const AddTransactionView: React.FC<AddTransactionViewProps> = (props) => {
